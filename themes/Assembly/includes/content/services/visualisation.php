		<div class="visualisation-wrapper individual-service" data-service="visualisation">
			...
			<div class="tile wide-1 content-tile right content-1" data-ratio=".07">
				...
				<div class="tile-inner">
					<div class="tile-img">
						<img data-src="<?php echo get_template_directory_uri(); ?>/library/images/pages/services/<?php echo $imageDir; ?>/03-Vis.jpg" alt="visualisation">
					</div>
				</div>
			</div>
			<div class="tile tall-1 content-tile left content-2" data-ratio=".06">
				...
				<div class="tile-inner">
					<div class="tile-img">
						<img data-src="<?php echo get_template_directory_uri(); ?>/library/images/pages/services/<?php echo $imageDir; ?>/01-Vis.jpg" alt="visualisation">
					</div>
				</div>
			</div>
		</div>