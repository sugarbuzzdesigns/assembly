			<?php if($deviceType === 'tablet' || $deviceType === 'mobile'){
				...
				<footer id="page-footer" class="footer" role="contentinfo" itemscope itemtype="http://schema.org/WPFooter">
					<div class="footer-inner">
						<div class="col">
							<a class="open-contact-drawer" href="/contact">plan a project. say hello.</a>
							<svg class="down-carrot" viewBox="0 0 19 13" xmlns="http://www.w3.org/2000/svg">
							  	<path d="M3 3.008l6.616 8.536L16.232 3" stroke-width="3" stroke="#FFF" fill="none" fill-rule="evenodd" stroke-linecap="square" stroke-linejoin="bevel"></path>
							</svg>
						</div>
			...
			<div id="contact-drawer" data-to-top-anchor="contact-drawer">
				<div class="contact-content">
					...
					<div class="no-mobile to-top-wrap">
						<div class="to-top contact-drawer-to-top">
