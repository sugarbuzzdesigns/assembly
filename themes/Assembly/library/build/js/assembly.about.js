/* repo: assembly/ - Package Version: 1.0.0 - 2017-04-18 12:31 pm - User: Phoydar */
/*!
...
(function($){
	assembly.about = {
		...
		bindEvents: function(){
			...
			$('.employee-carousel .slide.employee').on('click', function mobileEmployeeClickHandler(evt){
				evt.stopPropagation();

				var employeeName = $(this).data('employee-info');

				$('.employee-info[data-employee="'+ employeeName +'"]').addClass('show');

				$('.employees').addClass('info-open').css({minHeight: $('.employee-info[data-employee="'+ employeeName +'"]').height() + 50});
			});
		...
		initializeVideos: function(){
			...
			videojs('about-video-reel', {
				'autoplay': false,
				'controls': true
			}, function(){
				_this.aboutVideoReel = this;

				$('#about-video-reel').data('videojs', this);
				$('#about-video-overlay').data('videojs', this);
